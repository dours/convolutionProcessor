...
SC_MODULE(Unit) {
    sc_inout<sc_uint<DATA_WIDTH> > data[N_REGS][VECTOR_ALU_WIDTH];
    sc_inout<sc_uint<DATA_WIDTH> > local_data[N_REGS][VECTOR_ALU_WIDTH];

    sc_signal<sc_uint<DATA_WIDTH> > next_data[N_REGS][VECTOR_ALU_WIDTH];
    sc_signal<sc_uint<DATA_WIDTH> > next_local_data[N_REGS][VECTOR_ALU_WIDTH];
